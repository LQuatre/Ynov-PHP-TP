...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        // Attempt login
        $result = $member->login($email, $password); // Assuming a login method exists
        if ($result === true) {
            // Redirect to the dashboard or home page upon successful login
            header('Location: /dashboard'); // Change this to your desired location
            exit;
        } else {
            $error = $result; // Error message returned by the login method
        }
    }
}
?>

<div class="h-screen flex flex-col justify-center h-screen overflow-hidden">
